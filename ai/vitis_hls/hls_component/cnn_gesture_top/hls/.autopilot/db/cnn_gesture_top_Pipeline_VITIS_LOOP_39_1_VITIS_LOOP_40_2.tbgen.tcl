set moduleName cnn_gesture_top_Pipeline_VITIS_LOOP_39_1_VITIS_LOOP_40_2
set isTopModule 0
...
set cdfgNum 13
set C_modelName {cnn_gesture_top_Pipeline_VITIS_LOOP_39_1_VITIS_LOOP_40_2}
...
dict set ap_memory_interface_dict conv1_out { MEM_WIDTH 16 MEM_SIZE 6400 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ input_0 int 16 regular {array 300 { 1 1 } 1 1 }  }
	{ input_1 int 16 regular {array 300 { 1 1 } 1 1 }  }
	{ conv1_out int 16 regular {array 3200 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "input_0", "interface" : "memory", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "conv1_out", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ conv1_out_address0 sc_out sc_lv 12 signal 2 } 
	{ conv1_out_ce0 sc_out sc_logic 1 signal 2 } 
	{ conv1_out_we0 sc_out sc_logic 1 signal 2 } 
	{ conv1_out_d0 sc_out sc_lv 16 signal 2 } 
	...
	{ grp_fu_1478_p_dout0 sc_in sc_lv 64 signal -1 } 
	{ grp_fu_1478_p_ce sc_out sc_logic 1 signal -1 } 
	{ grp_fu_1481_p_din0 sc_out sc_lv 32 signal -1 } 
	...
	{ grp_fu_1484_p_dout0 sc_in sc_lv 64 signal -1 } 
	{ grp_fu_1484_p_ce sc_out sc_logic 1 signal -1 } 
	{ grp_fu_1487_p_din0 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_1487_p_dout0 sc_in sc_lv 64 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv1_out_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "conv1_out", "role": "d0" }} , 
 	...
 	{ "name": "grp_fu_1478_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "grp_fu_1478_p_dout0", "role": "default" }} , 
 	{ "name": "grp_fu_1478_p_ce", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "grp_fu_1478_p_ce", "role": "default" }} , 
 	{ "name": "grp_fu_1481_p_din0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "grp_fu_1481_p_din0", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_1484_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "grp_fu_1484_p_dout0", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_1487_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "grp_fu_1487_p_dout0", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "16047", "Max" : "16047"}
	, {"Name" : "Interval", "Min" : "16005", "Max" : "16005"}
]}
...
set Spec2ImplPortList { 
	...
	conv1_out { ap_memory {  { conv1_out_address0 mem_address 1 12 }  { conv1_out_ce0 mem_ce 1 1 }  { conv1_out_we0 mem_we 1 1 }  { conv1_out_d0 mem_din 1 16 } } }
}
